...
public class URLRewriteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        out.println("<p>");
        out.println("Username received successfully using ");
        out.println("<b>URL Rewriting</b>.");
        out.println("</p>");

        out.println("<p>");
        out.println("The username was passed as a query parameter ");
        out.println("in the URL.");
        out.println("</p>");
